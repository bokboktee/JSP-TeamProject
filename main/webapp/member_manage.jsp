...
/* 
 // submit 버튼 선택
    const submitButton = document.querySelector('#updateMemberForm [type="submit"]');

    // 클릭 이벤트 등록
    submitButton.addEventListener('click', () => {
      // updateMemberRole.do 경로로 이동
      document.getElementById('updateMemberForm').submit();
    });


 // 닫기 버튼 선택
    const closeButton = document.querySelector('.report-closeBtn');
    ...
    closeButton.addEventListener('click', () => {
      ...
      // 모달창에 'report-modal-hidden' 클래스 추가
