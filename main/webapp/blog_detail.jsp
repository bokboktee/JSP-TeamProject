	...
	<div id="reply">
		<div id="replyDetail">
			...
			<ul style="font-size: 13px; float: left; display: flex;" id="replyInfo">
				...
				<li>
					<img class="reportBtn" style="width: 20px; cursor: pointer; margin-left: 10px;" src="img/siren.png">
				</li>
			</ul>
		</div>
		...
		<div id="rereplywrite">
			<form action="#" method="post" style="width:90%;">
				<ul>
					<li style="float: left; list-style: none; width: 80%; margin: 10px;">
						<textarea style="border-radius: 5px; border: 1.7px solid #6667ab6b; width: 100%; height: 50px;" name="reply" placeholder="댓글을 작성하세요" required></textarea>
					</li>

					<li style="float: left; list-style: none; margin-left: -10px;">
						<input style="border: 1px solid #6667ab42; float: right; color: white; padding: 10px; border-radius: 5px; background-color: #6667AB; margin: 10px; width:80%; " type="submit" value="댓글 작성">
					</li>
				</ul>
				<br>
			</form>
 ...
 -->
	...
	<script type="text/javascript">
		...
		/* export const convertURLtoFile = async (url: string) => {
			  ...
			  const metadata = { type: `image/cat1.jpg` };
			  return new File([data], filename!, metadata);
			};
			var imgUrl=convertURLtoFile; */
